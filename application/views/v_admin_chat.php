   ...
   ScrollToBottom();
     ...
     objDiv.scrollTop = objDiv.scrollHeight;
   	...
   	function getData(){
	   	...
	   	$.ajax({
	   		url:'<?php echo base_url()?>admin/chatboot_list_data',
	   		type:'GET',
	   		success:function(data){
	   			...
	   			$('#list-pesan').html(data);
	   			 // $('#list-pesan').animate({ scrollTop:100000 },"slow");
           ScrollToBottom();
	   		}
	   	})
   	}
   	...
   	function addData(user_id,pesan_tipe,pesan_isi){
   		 	$.ajax({
	   		url:'<?php echo base_url()?>admin/chatboot_list_add',
	   		type:'POST',
	   		data:{
	   			user_id:user_id,
	   			pesan_isi:pesan_isi,
    ...
    function addDataBoot(user_id,pesan_isi){
   		 	$.ajax({
	   		url:'<?php echo base_url()?>admin/chatboot_list_addboot',
	   		type:'POST',
	   		data:{
	   			user_id:user_id,
	   			pesan_isi:pesan_isi,
