		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<table width="50%">
						<tr>
							<td colspan="3">
								<div class="form-group">
									...
									<a href="<?php echo base_url();?>admin/nilaiuts" class="btn btn-sm btn-danger">Nilai UTS
									</a>
						...
						<tr>
							...
							<td>:</td>
							<td>
								<select type="text" class="form-control select2" onchange="if (this.value) window.location='<?php echo base_url();?>admin/nilaiuts/'+this.value">
								<?php
								if($wherekelas==""){
						...
						<tr>
							<td colspan="3">
							<div class="form-group">
								<a href="<?php echo base_url();?>admin/nilaiuts/<?php echo $wherekelas;?>/ubah" class="btn btn-info"> <i class="fa fa-pencil"></i> Ubah</a>
							  </div>
							</td>
						</tr>
						<?php } ?>
				...
				if($whereopsi=="tambah"  && $wherekelas!=""){	
				   ...
				   echo form_open_multipart("admin/nilai_uts_aksi_tambah/$wherekelas", $attributes1); ?>
				  <table id="nilai3" class="table table-bordered table-striped " style="width:100%;">
					...
					<?php
						...
						foreach($tbl_admin_inputnilai as $data){
							  ...
							  <td><input maxlength='3' size='3' type='number' name='nilai_uts[]'></td>
							  </tr>";
							$no++;
						}
					?>
				  ...
				  <?php echo form_close(); 
				   ...
				   echo form_open_multipart("admin/nilai_uts_aksi_ubah/$wherekelas", $attributes2);
				?>
				...
				<?php					
					$no = 1;
						foreach($tbl_admin_nilai_uts as $data){
							  echo "<tr>
							  <td>".$no."<input type='hidden' name='uts_id[]' value='".$data->uts_id."'>
							  </td>
							  <td>".$data->user_nim."</td>
							  <td width='150px'>".$data->user_fullname."</td>
							  <td><input maxlength='3' size='3' type='number' name='nilai_uts[]' value='".$data->nilai_uts."'></td>
							  </tr>";
							$no++;
						}?>
					</tbody>
