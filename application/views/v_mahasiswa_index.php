...
error_reporting(0);
//Definisikan URL
$geturlindex = $this->uri->segment(2);
$geturlkelas = $this->uri->segment(3);
$geturltopik = $this->uri->segment(4);
//$geturljumlahgroup = $this->uri->segment(5);
if($geturlkelas!="" && $geturltopik!=""){
	$group = $this->db->query("select * from tbl_group where kelas_id='$geturlkelas' and topik_group='$geturltopik'")->row();
	$jumlah_group = $group->jumlah_group;
}else{
	$jumlah_group = 8;
}
$geturljumlahgroup = $jumlah_group;
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body no-padding">
					<table class="table table-striped table-bordered tabel-condensed">
					<tr><td width="25%">NIM</td><td width="3%"> : </td><td><?php echo $tbl_users_by->user_nim;?></td>
					<td width="250" rowspan="4"  style="text-align: center;">
						<img width="150" class="img" src="<?php echo base_url();?>assets/avatar/<?php echo $tbl_users_by->user_image."?".strtotime("now");?>">
					</td>
					...
					<tr><td width="25%">Nama Lengkap</td><td width="3%"> : </td><td><?php echo $tbl_users_by->user_fullname;?></td></tr>
					<tr><td width="25%">Email</td><td width="3%"> : </td><td><?php echo $tbl_users_by->user_email;?></td></tr>
					<tr><td width="25%">Semester</td><td width="3%"> : </td><td><?php echo $tbl_users_by->user_semester;?></td></tr>
					</table>
				</div>
			</div>
		</div>
				...
				<div class="box-header">
						<table width="100%">
							...
							<div class="form-group">
								<select type="text" class="form-control select2" id="select2" onchange="if (this.value) window.location='<?php echo base_url();?>mahasiswa/index/'+this.value+'/0'">
									<?php
									$geturlkelas = $this->uri->segment(3);
									if($geturlkelas!="0"  AND $geturlkelas!=""){
										echo "<option value='".$tbl_admin_kelas_2->kelas_id."'>".$tbl_admin_kelas_2->kelas_nama."</option>";
									}else{
										echo "<option>-- Pilih Kelas --</option>";
									}
									
									foreach($tbl_admin_kelas_group as $data1){
							...
							<td width="20%">
							<div class="form-group">
								<select type="text" class="form-control select2" onchange="if (this.value) window.location='<?php echo base_url();?>mahasiswa/index/<?php echo $geturlkelas;?>/'+this.value">
									<?php
									if($geturltopik!="0" AND $geturltopik!=""){
				...
				<div class="box">
					...
					<div class="box-body">
					  <table id="example8" class="table table-bordered table-striped" border="1" width="100%">
						<thead>
						<tr>
							<th style="text-align:center;" colspan="<?php echo $jumlah_kelompok;?>">Anggota Kelompok</th>
						</tr>
						<tr>
						<?php 
