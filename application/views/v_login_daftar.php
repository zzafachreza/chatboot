	...
	<div id="daisyjs" style="background-color:  #58985C;width: 100%;height: 800px;">
					...
					<div style="height: 200px;margin:5%">
						...
						?>
							...
							<div style="width:450px;background-color: white;border-radius: 20px;margin:5%;padding-left:5%;padding-right:5%;padding-top:5%;padding-bottom:2%;opacity: 0.8;box-shadow: 1px 1px 15px gray">
								...
								<form action="<?php echo base_url('login/aksi_daftar'); ?>" method="post">
									...
									<div class="form-group">
										<label style="color: <?php echo $color ?>">Full Name</label>
										<input type="text" name="user_nim" style="border-radius: :10px;width: 100%;height: 40px;border-radius: 0px;border-top:0px;border-right: 0px;border-left: 0px;border-bottom: 1px solid <?php echo $color ?>" placeholder="Enter your full name" autocomplete="off">
									</div>

									<div class="input-group">

										<select name="user_semester" style="width: 200px;height: 40px;margin-top:5%;margin-bottom: 5%;border-radius: 5px;border: 1px solid <?php echo $color ?>;padding: 5%">
									...
									<div class="form-group">
										<label style="color: <?php echo $color ?>">E-mail</label>
										<input type="text" name="user_email" style="border-radius: :10px;width: 100%;height: 40px;border-radius: 0px;border-top:0px;border-right: 0px;border-left: 0px;border-bottom: 1px solid <?php echo $color ?>" placeholder="Enter your email" autocomplete="off" autofocus="autofocus">
									</div>
									...
									<div class="form-group">
										<label style="color: <?php echo $color ?>">Retype Password</label>
										<input type="password" name="user_password2" style="border-radius: :10px;width: 100%;height: 40px;border-radius: 0px;border-top:0px;border-right: 0px;border-left: 0px;border-bottom: 1px solid <?php echo $color ?>" placeholder="Enter your password">
									</div>

									<div class="form-group">
										<button style="background-color: #58985C;width: 100%;border-radius: 10px;height: 45px;margin-top: 5%;border: 0px;color: #FFF;font-size: 14pt" type="submit">DAFTAR</button>
