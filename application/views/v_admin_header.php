...
<div class="wrapper">
  ...
  if(strpos($geturl, "tanya")!== FALSE){
    $menu_tanya = "active";
  }
   if(strpos($geturl, "beyes")!== FALSE){
    $menu_beyes = "active";
  }
   if(strpos($geturl, "probabilitas")!== FALSE){
    $menu_probabilitas = "active";
  }
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      <ul class="sidebar-menu">
       ...
       <li class="<?php echo $menu_tanya;?>">
          <a href="<?php echo base_url(); ?>admin/tanya">
            <i class="fa fa-file-text"></i> <span>DATA TANYA JAWAB</span>
          </a>
        </li>

        <li class="<?php echo $menu_beyes;?>">
          <a href="<?php echo base_url(); ?>admin/beyes">
            <i class="fa fa-file-text"></i> <span>DATA NAIVE BEYES</span>
          </a>
        </li>


       <li class="<?php echo $menu_probabilitas;?>">
          <a href="<?php echo base_url(); ?>admin/probabilitas">
            <i class="fa fa-line-chart"></i> <span>PROBABILITAS</span>
          </a>
        </li>
