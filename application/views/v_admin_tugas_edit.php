					...
					<div class="col-md-6">
					  <div class="form-group">
						...
						<select type="text" class="form-control select2" name="kelas_id">
							<option value="<?php echo set_value('kelas_id', $tbl_admin_tugas->kelas_id); ?>"><?php echo set_value('kelas_nama', $tbl_admin_tugas->kelas_nama); ?></option>
							<?php
					  ...
					  <div class="form-group">
						<label>topik</label>
						<input type="text" class="form-control" name="tugas_topik" value="<?php echo set_value('tugas_topik', $tbl_admin_tugas->tugas_topik); ?>">
					  </div>
					  <div class="form-group">
